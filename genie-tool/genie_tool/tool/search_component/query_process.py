...
async def query_decompose(
    ...
    model = os.getenv("QUERY_DECOMPOSE_MODEL", "deepseek-ai/DeepSeek-V3.1-Terminus")
    think_model = os.getenv("QUERY_DECOMPOSE_THINK_MODEL", "deepseek-ai/DeepSeek-V3.1-Terminus")
